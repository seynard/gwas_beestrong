...
echo ${pheno}
sbatch -o ${dir}/log/gwas_gemma_${type}_${grm_type}_freq_${pheno}.out -e ${dir}/log/gwas_gemma_${type}_${grm_type}_freq_${pheno}.err --mem=100G --wrap="gemma -g ${infile} -p ${dir_out}/pheno_${pheno}_${type}.txt -k ${grm} -lmm 1 -c ${cov_file} -n 1 -notsnp -outdir ${dir_out} -o ./gemma_${type}_${pheno}_${grm_type}_lmm_freq_cov"
done
else
for i in ${pheno_id[@]}
do
...
pheno=$(echo ${pheno} | awk '{gsub(/_'"$type"'/,"")}1')
echo ${pheno}
sbatch -o ${dir}/log/gwas_gemma_${type}_${grm_type}_freq_${pheno}.out -e ${dir}/log/gwas_gemma_${type}_${grm_type}_freq_${pheno}.err --mem=100G --wrap="gemma -g ${infile} -p ${dir_out}/pheno_${pheno}_${type}.txt -k ${grm} -lmm 1 -n 1 -notsnp -outdir ${dir_out} -o ./gemma_${type}_${pheno}_${grm_type}_lmm_freq_cov"
done
fi
